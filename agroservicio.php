...
if(isset($_REQUEST['politica-cookies'])) {
    ...
    setcookie('nuevo', 'Usuario', $caducidad);
...
<head>
  ...
  <link rel="stylesheet" href="estilos.css"><!-- Para cookie-->
...
<div class=" jumbotron colorfondo1">
  ...
  <br>     
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 text-center">
                          ...
                          <img src="imgagro\producto.png">
                            ...
                            <a href="verproductos.php" class="btn btn-primary">Ver Productos</a>
          ...
          <div class="row">
            <div class="col">
              ...
              <div class="col">
                <div style="background-color:#D5D9D8">
                  <div class="container">          
                    <form action="correoelectronico.php" method="post">
      ...
      <div style="background-color:#444D59">
        ...
        <div><!-- para cookie-->
        <?php if (!isset($_REQUEST['politica-cookies']) && !isset($_COOKIE['nuevo'])): ?>
            <!-- Mensaje de cookies -->
            <div class="cookies">
                <h2 class="text1">Aviso</h2>
                <p class="text">Es importante que coloques tu informacion verdadera para evitar inconvenientes con nuestros servicios.</p>
                <a href="?politica-cookies" class="btn btn-primary btn-lg" style="float:right;" >Aceptar</a>
            </div>
        <?php endif; ?>
    </div>
