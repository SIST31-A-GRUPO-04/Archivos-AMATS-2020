	...
	<table class="table table-bordered table-dark">
		<tr>
			...
			<td>
				...
				<input name="nom_proveedor" type="text" value="<?php echo $fila["nom_proveedor"]?>" required oninvalid="this.setCustomValidity('no ha agregado ningun Proveedor')" oninput="this.setCustomValidity('')"  />
			</td>
		</tr>
		<tr>
