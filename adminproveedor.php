...
<section class="container mt-5 col-md-6" style="background-color: white">
	...
	<form method="post">
		<table class="table table-bordered">
			<tr>
				<td>Proveedor</td>
				<td><input name="proveedor" type="text" required oninvalid="this.setCustomValidity('aun no ha agregado ningun proveedor')" oninput="this.setCustomValidity('')"  /></td>
			</tr>
			...
			<thead class="thead-dark">
				...
				while($fila=$rs->fetch_assoc()){
					...
					<tr>				
						...
						<form method="post" action="imprimirproveedores.php">							
							<center><input type="submit" name="imprimirproveedor" value="Generar Reporte" class="btn btn-success"></center>
						</form>
					</div>
